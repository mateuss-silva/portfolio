document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        "en": {
            ...
            "about_text": "Senior Mobile Engineer specialized in Flutter with a deep foundation in native iOS and Android development. I have a proven track record of delivering high-performance applications across national and international financial markets, including complex white-label projects. I master reactive programming and Clean Architecture to build robust, scalable products, always with a critical focus on security and technical excellence.",
            "about_edu": "Graduated in Computer Science from UFS.",
            "skills_title": "Core Expertise",
            "projects_title": "Strategic Projects",
            
            "project_guard_title": "Guardian Invest",
            "project_guard_desc": "Premium fintech platform focused on uncompromising security. Features real-time trading, biometric verification, and advanced session protection.",
            "project_guard_tech": "Clean Architecture | Flutter BLoC | RxDart Streams | JWT Rotation | Fastify",
            ...
            "projects_details": {
                "guard": {
                    "title": "Guardian Invest",
                    "subtitle": "Premium, secure fintech application designed as a financial fortress.",
                    "arch": "Clean Architecture (Data/Domain/Presentation)",
                    "state": "Flutter BLoC + RxDart Streams",
                    "patterns": "Repository, Dependency Injection (GetIt), Interceptor Pattern (Dio)",
                    "github": "https://github.com/mateuss-silva/fintech_session_guard",
                    "demo_url": "https://mateuss-silva.github.io/fintech_session_guard",
                    "description": "Guardian Invest is a mission-critical fintech solution. It enables real-time portfolio management, trading, and secure transactions, all while being protected by biometric verification and advanced session management logic.",
                    "tech_details": "Key technical highlights: <ul><li><strong>Advanced Security:</strong> Implemented short-lived <strong>JWT rotation</strong> with reuse detection to prevent session hijacking. All sensitive data is stored in the native secure enclave.</li><li><strong>Reactive Trading Flow:</strong> Real-time asset pricing powered by <strong>RxDart Streams</strong> and <strong>Fastify (Node.js)</strong> backend, ensuring minimal latency.</li><li><strong>Clean Architecture:</strong> Strict adherence to domain-driven design, decoupling business logic from the UI framework for 100% testability.</li><li><strong>Production-Ready CI/CD:</strong> Fully automated web deployment to <strong>GitHub Pages</strong> with a containerized <strong>Render</strong> backend.</li></ul>",
                    "images": [
                        "https://raw.githubusercontent.com/mateuss-silva/fintech_session_guard/master/assets/images/home.png",
                        "https://raw.githubusercontent.com/mateuss-silva/fintech_session_guard/master/assets/images/graph.png",
                        "https://raw.githubusercontent.com/mateuss-silva/fintech_session_guard/master/assets/images/graph-details.png"
                    ]
                },
                "ai": {
        ...
        "pt": {
            ...
            "about_text": "Engenheiro Mobile Sênior especialista em Flutter com sólida experiência em desenvolvimento nativo iOS e Android. Possuo uma trajetória consolidada na entrega de aplicações de alta performance em mercados financeiros nacionais e internacionais, incluindo projetos white-label complexos. Domino programação reativa e Clean Architecture para construir produtos robustos e escaláveis, focando sempre em segurança, excelência técnica e na resolução de desafios de negócio.",
            "about_edu": "Graduado em Ciência da Computação pela UFS.",
            "skills_title": "Especialidades Core",
            "projects_title": "Projetos Estratégicos",
            
            "project_guard_title": "Guardian Invest",
            "project_guard_desc": "Plataforma fintech premium focada em segurança intransigente. Inclui trading em tempo real, biometria e proteção de sessão avançada.",
            "project_guard_tech": "Clean Architecture | Flutter BLoC | RxDart Streams | Rotação JWT | Fastify",
            ...
            "projects_details": {
                "guard": {
                    "title": "Guardian Invest",
                    "subtitle": "Aplicação fintech premium e segura, desenhada como uma fortaleza financeira.",
                    "arch": "Clean Architecture (Data/Domain/Presentation)",
                    "state": "Flutter BLoC + RxDart Streams",
                    "patterns": "Repository, Dependency Injection (GetIt), Interceptor Pattern (Dio)",
                    "github": "https://github.com/mateuss-silva/fintech_session_guard",
                    "demo_url": "https://mateuss-silva.github.io/fintech_session_guard",
                    "description": "O Guardian Invest é uma solução fintech de missão crítica. Permite gerenciamento de carteira em tempo real, negociação e transações seguras, tudo protegido por verificação biométrica e lógica avançada de gerenciamento de sessão.",
                    "tech_details": "Destaques técnicos: <ul><li><strong>Segurança Avançada:</strong> Implementação de <strong>rotação de JWT</strong> de curta duração com detecção de reuso para prevenir sequestro de sessão. Dados sensíveis armazenados em enclave seguro nativo.</li><li><strong>Fluxo de Trade Reativo:</strong> Preços de ativos em tempo real via <strong>RxDart Streams</strong> e backend <strong>Fastify (Node.js)</strong>, garantindo latência mínima.</li><li><strong>Clean Architecture:</strong> Adesão rigorosa ao design orientado a domínio, desacoplando a lógica de negócio do framework UI para 100% de testabilidade.</li><li><strong>CI/CD Pronto para Produção:</strong> Deploy web automatizado para <strong>GitHub Pages</strong> com backend <strong>Render</strong>.</li></ul>",
                    "images": [
                        "https://raw.githubusercontent.com/mateuss-silva/fintech_session_guard/master/assets/images/home.png",
                        "https://raw.githubusercontent.com/mateuss-silva/fintech_session_guard/master/assets/images/graph.png",
                        "https://raw.githubusercontent.com/mateuss-silva/fintech_session_guard/master/assets/images/graph-details.png"
